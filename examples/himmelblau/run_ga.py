...
from examples.himmelblau.problem import HimmelblauProblem
from examples.himmelblau.plotting import HimmelblauPlotter
...
def main() -> None:
    ...
    out_dir = Path(f"examples/himmelblau/output_{timestamp}")
    ...
    parameters = [
        ContinuousParameter(
            ...
            description="Himmelblau x dimension",
            unit="units",
        ),
        ContinuousParameter(
            name="y",
            normalizer=LinearNormalization(-5.0, 5.0),
            description="Himmelblau y dimension",
            unit="units",
        ),
    ]
    ...
    plotter = HimmelblauPlotter(update_every=1, interactive=False)
