"""Plotting utilities for NSGA-II ZDT2 multi-objective optimization visualization."""
...
def plot_pareto_front(objectives: list[Sequence[float]], output_dir: Path, iteration: int = -1) -> None:
    ...
    title = f'NSGA-II on ZDT2 Problem - Generation {iteration}'
    ...
    # Plot true Pareto front for ZDT2
    problem = ZDT2Problem()
